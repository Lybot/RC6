...
namespace RC6 // W=32  R= 20 B = 128,192,256
{
    class Program
    {
        ...
        private static byte[] EncodeRc6Test(string plaintext)
        {
            uint A, B, C, D;
        ...
        private static byte[] DecodeRc6Test(byte[] cipherText)
        {
            uint A, B, C, D;
            int i;
            byte[] plainText = new byte[cipherText.Length];
        ...
        private static void Test()
        {
            ...
            GenerateKeyTest(128,MainKey);
            byte[] cipher = EncodeRc6Test(plaintTextstring);
            if (test==cipher)
        ...
        private static void Test2()
        {
            ...
            MainKey = new byte[] { 00, 01, 02, 03, 04, 05, 06, 07, 08, 09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f };
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                cipherText = EncodeRc6Test(plainText);
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
